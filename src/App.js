...
function App() {
  ...
  function getIndividualTransactions({
    row
  }) {
  ...
  return transactionData == null ? ( <div> Loading... </div>
  ) : ( <div>
    <div className = "container" >
    <div className = "row" >
    <div className = "col-10" >
    <h2> Points Reward Totals by Customer Months </h2> </div> </div> 
    <div className = "row" >
    <div className = "col-8" >
    <Styles >
    <Table columns = {
    ...
    data = {
      transactionData.summaryByCustomer
    }
...
/> 
  ...
  <div className = "row" >
  <div className = "col-10" >
  <h2 > Points Reward Totals By Customer </h2> </div> </div> 
  <div className = "row" >
  <div className = "col-8" >
  <Styles>
  <Table columns = {
...
data = {
  transactionData.totalPointsByCustomer
}
/> </Styles> </div> </div> </div> </div>
);
}
